...
LANGUAGE_CONFIG = {
    "English": {
        ...
        "greeting": "Hello! I'm FinVoice, your AI Financial Support Assistant. I can help you understand banking services, government schemes and stay safe from financial frauds. How may I help you today?",
    },
    "Hindi": {
        "instruction": "Respond ONLY in clear, natural conversational Hindi (हिंदी). DO NOT speak in Telugu or English.",
        "greeting": "नमस्ते! मैं फिनवॉ兴्स हूँ, आपका एआई वित्तीय सहायता सहायक। मैं आपको बैंकिंग सेवाओं और सरकारी योजनाओं को समझने में मदद कर सकता हूँ। आज मैं आपकी क्या मदद कर सकता हूँ?",
    },
    "Telugu": {
        "instruction": "Respond ONLY in clear, natural conversational Telugu (తెలుగు). DO NOT speak in Hindi or English.",
        "greeting": "నమస్కారం! నేను ఫిన్‌వాయిస్, మీ AI ఆర్థిక సహాయకుడిని. నేను మీకు బ్యాంకింగ్ సేవలు, ప్రభుత్వ పథకాలను అర్థం చేసుకోవడానికి సహాయపడగలను. ఈరోజు నేను మీకు ఎలా సహాయపడగలను?",
    },
    "Hinglish": {
        "instruction": "Respond naturally in Hinglish, mixing Hindi and English conversationally.",
        "greeting": "Hello! Main FinVoice hoon, aapka AI financial support assistant. Main aapko banking services aur govt schemes samajhne me help kar sakta hoon. Aaj main aapki kya help kar sakta hoon?",
    },
}
...
async def my_agent(ctx: JobContext):
    ...
    logger.info(
        f"Starting session for participant {participant.identity if participant else 'unknown'} with language: {user_lang}"
    )
    ...
    # Deliver initial greeting in the user's chosen language
